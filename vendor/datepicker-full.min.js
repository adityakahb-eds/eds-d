!(function () {
  ...
  const O = {
      ...
      m(e, t, i) {
        ...
        if (isNaN(n)) {
          ...
          if (((n = i.monthsShort.findIndex(s)), n < 0 && (n = i.months.findIndex(s)), n < 0))
            return NaN;
        }
  ...
  function se(e, i) {
    ...
    if ('minDate' in s) {
      const e = c(0, 0, 1);
      ((k = null === s.minDate ? e : ee(s.minDate, d, h, k)),
        k !== e && (k = b(k, m, !1)),
        delete s.minDate);
    }
    if (
      ...
      if ('function' == typeof e)
        ((n.datesDisabled = null), (n.checkDisabled = (t, i) => e(new Date(t), i, r)));
      else {
    ...
    if (
      ...
      s.daysOfWeekHighlighted &&
        ((n.daysOfWeekHighlighted = s.daysOfWeekHighlighted.reduce(G, [])),
      ...
      if (e) {
        const t =
          'function' == typeof e ? (t, i) => e(new Date(t), i) : Q((e = parseInt(e, 10)), y);
  ...
  const ae = (e) =>
      e
        .map((e) => `<button type="button" class="%buttonClass% ${e}" tabindex="-1"></button>`)
        .join(''),
    re = r(
  ...
  class ue extends ce {
    ...
    setOptions(e) {
      ...
      (e.checkDisabled &&
        (this.checkDisabled =
          this.isMinView || null === e.datesDisabled ? e.checkDisabled : () => !1),
    ...
    render() {
      (this.prepareForRender(
        ...
        Array.from(this.grid.children).forEach((e, t) => {
          ...
          ((e.dataset.year = i),
            this.renderCell(e, i, i, s, this, i < this.minYear || i > this.maxYear));
        }));
    }
    refresh() {
      const e = this.range || [];
  ...
  const Se = ['left', 'top', 'right', 'bottom'].reduce(
  ...
  function Ee(e) {
    ...
    if (t !== document.body && t)
      return 'visible' !== window.getComputedStyle(t).overflow ? t : Ee(t);
  }
  class Ae {
    constructor(e) {
    ...
    'ArrowLeft' === r
      ...
      : 'ArrowRight' === r
        ...
        : 'ArrowUp' === r
          ...
          : 'ArrowDown' === r
            ? p(1, !0)
            : ('Backspace' === r || 'Delete' === r || (r && 1 === r.length && !c)) &&
              e.enterEditMode();
  }
  function _e(e) {
  ...
  function Pe(e, t, i) {
    ...
    (void 0 === a && (a = !0),
      a ? void 0 === r && (r = s.autohide) : (r = d = !1),
      (c = V(c, s.format, s.locale)));
    const l = $e(e, t, n);
    (l || o) &&
      (l && l.toString() !== e.dates.toString()
        ? ((e.dates = l), Ie(e, a ? 3 : 1, !0, c), pe(e, 'changeDate'))
        : Ie(e, d ? 3 : 1, !0, c),
      r && e.hide());
  }
  function Je(e, t) {
      ...
      ((this._options = t),
        ...
        (n.shortcutKeys = (function (e) {
          return Object.keys(ne).reduce((t, i) => {
            ...
            return (
              n.length > 1 && ((a.altKey = !!s.altKey), (a.shiftKey = !!s.shiftKey)),
              (t[i] = a),
              t
            );
          }, {});
  ...
  function ze(e, t) {
    ...
    (void 0 !== c && void 0 !== l
      ...
      : e.allowOneSidedRange ||
        (void 0 === c && void 0 === l) ||
        ((r.clear = !0), s[d].setDate(s[o].dates, r)),
      s.forEach((e) => {
